...
def get_prediction():
    ...
    # sepal length
    sepal_length = float(request.args.get('sl')) #konwertujemy do liczby stąd jest metoda float
    # sepal width
    ...
    features = [sepal_length,
                petal_length]
    # zbieram to co uzytkownik mi wpisał
...
# wysyłam normalnie odbieram w formie jasona
